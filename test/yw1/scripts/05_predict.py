...
OUTPUT_DIR = ROOT_DIR  / "yw1" / "data" / "inference" / "output"

# --- Prediction Settings ---
CONFIDENCE_THRESHOLD = 0.3 # Only detect objects with confidence > 25%
...
def predict_on_webcam():
    ...
    try:
        ...
        # Iterate through the generator to process the stream2
